...
import { GET_ALL_LESSONS, GET_ALL_FEEDBACKS, GET_ALL_COURSES, GET_ALL_SINGLE_DATA, GET_ALL_COMMENTS, GET_ALL_VIDEOBLOGS } from './actionTypes';
import { getLessons, getFeedbacks, getCourses, getSingledata, getComments, getVideoblogs } from './api';
