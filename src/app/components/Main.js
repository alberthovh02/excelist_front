            ...
            <>
                    ...
                    <div className="statistic_item" style={{textAlign: 'center'}}>
                        ...
                        <p>
                            {this.state.youtubeSubscribersCount && <CountUp
                                start={0}
                                end={this.state.youtubeSubscribersCount
                                    && this.state.youtubeSubscribersCount.items
                                    && this.state.youtubeSubscribersCount.items[0].statistics.viewCount
                                }
                                duration={4}
                                delay={2}
                                style={{fontWeight: 'bold', fontSize: '0.8em', marginBottom: 0}}
                    ...
                    <div className="excelist_desc">
                        <div className="our_team">
                            <div className="team_member">
                                ...
                                <p className="member_name">
                                    <a href="#" target="_blank" className="innerTexts">
                                        <a href="https://web.facebook.com/armen.petrosyan.25?_rdc=1&_rdr"
                                           target="_blank"><i className="fa fa-facebook"/></a>
                                        <a href="https://www.linkedin.com/in/armen-petrosyan-47751229/ru"
                                           target="_blank"><i className="fa fa-linkedin"/></a>
                                    </a>
                                </p>
                            ...
                            <div className="team_member">
                                ...
                                <p className="member_name">
                                    <a href="#" target="_blank" className="innerTexts">
                                        <a href="https://web.facebook.com/Mr.Excelist?_rdc=1&_rdr" target="_blank"><i
                                            className="fa fa-facebook"/></a>
                                        <a target="_blank"><i className="fa fa-skype"></i></a>
                                        <a href="https://www.linkedin.com/in/excelist/" target="_blank"><i
                            ...
                            <div className="team_member">
                                ...
                                <p className="member_name">
                                    <a href="#" target="_blank" className="innerTexts">
                                        <a href="https://web.facebook.com/arman.harutyunyan.y" target="_blank"><i
                                            className="fa fa-facebook"/></a>

                                        <a href="https://www.linkedin.com/in/arman-harutyunyan-439ba8151/"
                                           target="_blank"><i className="fa fa-linkedin"/></a>

                                    </a>
                                </p>
                                <a href="/our-team/3" target="_blank"><p className="name-title">ԱՐՄԱՆ ՀԱՐՈՒԹՅՈՒՆՅԱՆ</p>
                                </a>
                                <p>Էքսելիստ</p>
                            </div>
                        </div>
                                ...
                                <div className="col-sm-10 perfect_column_center">
                                    ...
                                    <div style={{
                                        ...
                                        <div className='perfect_column_center'>
                                            ...
                                            /><br/>
                                            <a className="register-for-lesson" target="_blank" href="/register"><i
                ...
                <div style={{ marginLeft: 'auto', marginRight: 'auto'}}>
                    ...
                    <div style={{display: 'flex', justifyContent: 'center'}}>
                        {Feedbacks && <FeedbackCarousel infinite={true} responsive={responsive}
        ...
        return (
            <div>
                <Router history={history}>
                    ...
                    {authorized && window.location.pathname.includes("/dashboard") && <><Navbar/>{PrivateRoutes.map((item, key) => {
