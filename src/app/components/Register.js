...
export default function Register() {
  return (
    <>
      ...
      >
        <iframe
          title="ԴԱՍԸՆԹԱՑԻՆ ՄԱՍՆԱԿՑՈՒԹՅԱՆ ՀԱՅՏ"
          src="https://docs.google.com/forms/d/e/1FAIpQLSdeUlcWwLVjDouBRR-MwGby_sUOAQMsfGrl-cdi5rmsXlvQ5w/viewform?embedded=true&usp=embed_googleplus"
