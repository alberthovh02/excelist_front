...
class VideoBlogAdmin extends React.Component {
  ...
  handleSubmit = async (values) => {
    ...
    const { image, fileList, checked } = this.state;
    const {
      language,
      title,
      video_link,
    ...
    data.append("about_video", about_video);
    data.append("is_macrolab", checked);
    ...
    // }
    console.log(data, values, checked);
    this.setState({
      uploading: true,
    });
  ...
  handleOk = async (values) => {
    ...
    edit_file_link && data.append("file_link", edit_file_link);
    edit_about_video && data.append("about_video", edit_about_video);
    ...
    return (
      <div>
                  ...
                  <div key={key} className="videoblog-admin">
                    ...
                    >
                      <Form
                        ...
                        initialValues={{
                          ...
                          edit_about_video: item.about_video,
                          edit_file_link: item.file_link,
                          edit_is_macrolab: item.is_macrolab,
                        }}
                      >
                        <Form.Item
                          name="edit_name"
                        ...
                        <Form.Item name="edit_file_link" label="File link()">
                          <Input />
                        </Form.Item>
                        <Form.Item
                          name="edit_about_video"
                          label="Գրեք որևէ տեղեկատվություն"
                        >
                          <Input />
                        </Form.Item>
                      </Form>
                    ...
                    <div>
                      ...
                      <Button
                        ...
                        onClick={this.showModal.bind(null, item)}
                      >
                        EDIT
                      </Button>
                    </div>
        ...
        >
          ...
          <Form.Item name="file_link" label="File link()">
            <Input />
          </Form.Item>
